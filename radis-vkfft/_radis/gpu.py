...
# app.S_klm_d = GPUArray((1, 1, init_h.N_v_FT), np.float32, binding=3)
# app.S_klm_FT_d = GPUArray(
    # (1, 1, init_h.N_x_FT), np.complex64, binding=4
# )

# app.S_klm_d.reshape((N_L_max, N_G_max, init_h.N_v_FT))
# app.S_klm_FT_d.reshape((N_L_max, N_G_max, init_h.N_x_FT))
